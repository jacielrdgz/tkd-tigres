          ...
          {instructores.map(inst => (
            <div key={inst.id} style={{ ...s.instCard, padding: isMobile ? '14px' : '20px', gap: isMobile ? '12px' : '20px' }}>
              ...
              <div style={s.instInfo}>
                ...
                <div style={{ ...s.instBadge, background: getCintaColor(inst), marginBottom: '12px' }}>
                  {getCintaLabel(inst)}
                </div>
...
const s = {
  ...
  instCard: { background: 'var(--bg-secondary)', border: '1px solid var(--border)', borderRadius: '24px', padding: '20px', display: 'flex', alignItems: 'flex-start', gap: '16px', transition: 'all 0.2s' },
