          ...
          <div style={s.modalCard} className="mobile-fullscreen-modal">
            ...
            <div style={{
              ...
              <div style={{
                ...
                <InfoItem label="Teléfono" value={limpiarDato(alumnoVer.telefono_tutor)} isMobile={isMobile} />
                <InfoItem label="Correo" value={(alumnoVer.email && alumnoVer.email !== 'NULL' && alumnoVer.email !== 'null') ? alumnoVer.email : 'N/A'} isMobile={isMobile} />
                <InfoItem label="Status" value={capitalizar(alumnoVer.estatus)} isMobile={isMobile} />
              </div>
            </div>
            <div style={{
              ...s.cardFooter,
