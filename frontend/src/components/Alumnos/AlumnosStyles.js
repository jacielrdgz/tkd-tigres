/*export const s = {
  ...
  tabla: { background: '#13151f', borderRadius: '12px', overflowX: 'auto', border: '1px solid #1e2130' },
  table: { width: '100%', borderCollapse: 'collapse', minWidth: '950px' },
  th: { padding: '10px 16px', textAlign: 'left', fontSize: '12px', color: '#64748b', borderBottom: '1px solid #1e2130', textTransform: 'uppercase', whiteSpace: 'nowrap' },
  tr: { borderBottom: '1px solid #1e2130' },
  td: { padding: '8px 16px', fontSize: '14px', color: '#cbd5e1', verticalAlign: 'middle', whiteSpace: 'nowrap' },
  tdCenter: { padding: '32px', textAlign: 'center', color: '#475569' },
  fotoTabla: { width: '36px', height: '36px', borderRadius: '50%', objectFit: 'cover', border: '2px solid #1e2130' },
  fotoVacia: { width: '36px', height: '36px', borderRadius: '50%', background: '#1e2d4a', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '13px', fontWeight: '700', color: '#60a5fa' },
  nombreNom: { fontWeight: '600', color: '#f1f5f9' },
  emailSub: { fontSize: '12px', color: '#64748b', marginTop: '4px' },
